...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { color_theme: @style.color_theme, header_image: @style.header_image, layout: @style.layout }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { color_theme: @style.color_theme, header_image: @style.header_image, layout: @style.layout }
    assert_redirected_to style_path(assigns(:style))
  end
